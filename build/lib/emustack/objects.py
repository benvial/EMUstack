...
class NanoStruct(object):
    ...
    def __init__(
        ...
        if ff == 0:
            ...
            if diameter2 != 0:
                self.diameter2 = (
                    2 * ((ff * (period) ** 2) / np.pi - ((diameter1 / 2) ** 2)) ** 0.5
                )
            else:
        ...
        if self.periodicity == "2D_array":
            if self.inc_shape in ["circle", "ellipse", "square"]:
                if self.diameter10 > 0:
                    supercell = 16
                    msh_name = (
                        "%(d)s_%(dy)s_%(dia)s_%(dias)s_%(diass)s_%(diasss)s_%(diassss)s"
                        % {
                ...
                if (
                    ...
                    if self.is_hex is False:
                        geo_tmp = open(
                            template_location + "%s_msh_template.geo" % supercell, "r"
                        ).read()
                    else:
                        geo_tmp = open(
                            template_location + "hex_msh_template.geo", "r"
                        ).read()
                    ...
                    geo = geo.replace(
                        "ellipticity = 0;", "ellipticity = %f;" % self.ellipticity
                    )
                    if self.inc_shape == "square":
                ...
                if (
                    ...
                    geo_tmp = open(
                        template_location + "SRR_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm  = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                    geo = geo.replace(
                        "lvert_nm = 0;", "lvert_nm = %f;" % self.len_vertical
                    )
                    geo = geo.replace(
                        "lhori_nm = 0;", "lhori_nm = %f;" % self.len_horizontal
                    )
                    geo = geo.replace(
                        "width_nm = 0;", "width_nm = %f;" % self.diameter1
                    )
                    geo = geo.replace("lc = 0;", "lc = %f;" % self.lc)
                    geo = geo.replace("lc2 = lc/1;", "lc2 = lc/%f;" % self.lc2)
                    geo = geo.replace("lc3 = lc/1;", "lc3 = lc/%f;" % self.lc3)
                ...
                if (
                    ...
                    geo_tmp = open(
                        template_location + "ring1_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                if (
                    ...
                    geo_tmp = open(
                        template_location + "dimer1_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                msh_name = (
                    "square_dimer_%(d)s_%(dy)s_%(d_one)s_%(d_two)s_%(gap)s_%(smooth)s"
                    % {
                        "d": dec_float_str(self.period),
                        "dy": dec_float_str(self.period_y),
                        "d_one": dec_float_str(self.diameter1),
                ...
                if (
                    ...
                    geo_tmp = open(
                        template_location + "square_dimer1_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                msh_name = (
                    "square_shell_dimer_%(d)s_%(dy)s_%(d_one)s_%(d_two)s_%(d_three)s_%(d_four)s_%(gap)s_%(smooth)s_%(t)s"
                    % {
                        "d": dec_float_str(self.period),
                        "dy": dec_float_str(self.period_y),
                        "d_one": dec_float_str(self.diameter1),
                ...
                if (
                    ...
                    geo_tmp = open(
                        template_location + "square_shell_dimer1_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                if (
                    ...
                    geo_tmp = open(
                        template_location + "rect1_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                msh_name = (
                    "rect_shell_%(d)s_%(dy)s_%(d_one)s_%(d_two)s_%(smooth)s_%(t)s"
                    % {
                        "d": dec_float_str(self.period),
                        "dy": dec_float_str(self.period_y),
                        "d_one": dec_float_str(self.diameter1),
                ...
                if (
                    ...
                    geo_tmp = open(
                        template_location + "rect_shell1_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                if (
                    ...
                    geo_tmp = open(
                        template_location + "cross1_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                msh_name = (
                    "cross_shell_%(d)s_%(dy)s_%(d_one)s_%(d_two)s_%(smooth)s_%(t)s"
                    % {
                        "d": dec_float_str(self.period),
                        "dy": dec_float_str(self.period_y),
                        "d_one": dec_float_str(self.diameter1),
                ...
                if (
                    ...
                    geo_tmp = open(
                        template_location + "cross_shell1_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                if (
                    ...
                    geo_tmp = open(template_location + "L_msh_template.geo", "r").read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                if (
                    ...
                    geo_tmp = open(
                        template_location + "1_strip_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                msh_name = (
                    "double_strip_circle_%(d)s_%(dy)s_%(d_one)s_%(d_two)s_%(d_three)s"
                    % {
                        "d": dec_float_str(self.period),
                        "dy": dec_float_str(self.period_y),
                        "d_one": dec_float_str(self.diameter1),
                ...
                if (
                    ...
                    geo_tmp = open(
                        msh_location + "1_2strip_msh_template.geo", "r"
                    ).read()
                    geo = geo_tmp.replace("ff = 0;", "ff = %f;" % self.ff)
                    geo = geo.replace("d_in_nm = 0;", "d_in_nm  = %f;" % self.period)
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                ...
                msh_name = (
                    "double_strip_square_%(d)s_%(dy)s_%(d_one)s_%(d_two)s_%(d_three)s"
                    % {
                        "d": dec_float_str(self.period),
                        "dy": dec_float_str(self.period_y),
                        "d_one": dec_float_str(self.diameter1),
                ...
                if self.geo_file == None:
                    raise TypeError('Must provide a .geo file if inc_shape="custom".')
                ...
                if self.geo_file[-4:] != ".geo":
                    raise ValueError('Must provide a .geo file if inc_shape="custom".')
                ...
                for key, value in self.geo_params.items():
                    msh_name = (
                        ...
                        + "_"
                        + key
                        + "%(value)s" % {"value": dec_float_str(value)}
                    )
                ...
                if (
                    ...
                    geo = geo_tmp.replace(
                        "d_in_nm = 0;", "d_in_nm  = %f;" % self.period
                    )
                    geo = geo.replace("dy_in_nm = 0;", "dy_in_nm = %f;" % self.period_y)
                    geo = geo.replace("lc = 0;", "lc = %f;" % self.lc)
                    geo = geo.replace("lc2 = lc/1;", "lc2 = lc/%f;" % self.lc2)
            ...
            if self.diameter6 > 0:
                msh_name = (
                    "%(d)s_%(di)s_%(dis)s_%(diss)s_%(disss)s_%(dissss)s_%(disssss)s"
                    % {
                        "d": dec_float_str(self.period),
                ...
                if self.edge_spacing is True:
                    ...
                    for i_el in el_list:
                        ...
                        if (
                            ...
                            and 0.5 - 2.0 * i_d - 2.0 * rad_2 - 2.0 * rad_4 - rad_1
                            <= x_1
                            ...
                            and x_1
                            <= 0.5 + 2.0 * i_d + 2.0 * rad_3 + 2.0 * rad_5 + rad_1
                            ...
                            x_1 <= 0.5 - 3.0 * i_d - rad_1 - 2.0 * rad_2 - 2.0 * rad_4
                            and x_1
                            >= 0.5
                            - 3.0 * i_d
                            - rad_1
                            ...
                            - rad_5
                            and x_2
                            <= 0.5 - 3.0 * i_d - rad_1 - 2.0 * rad_2 - 2.0 * rad_4
                            and x_2
                            >= 0.5
                            - 3.0 * i_d
                            - rad_1
                            ...
                            x_1 >= 0.5 + 3.0 * i_d + rad_1 + 2.0 * rad_3 + 2.0 * rad_5
                            and x_1
                            <= 0.5
                            + 3.0 * i_d
                            + rad_1
                            ...
                            + 2.0 * rad_6
                            and x_2
                            >= 0.5 + 3.0 * i_d + rad_1 + 2.0 * rad_3 + 2.0 * rad_5
                            and x_2
                            <= 0.5
                            + 3.0 * i_d
                            + rad_1
                    ...
                    for i_el in el_list:
                        ...
                        if (
                            ...
                            and 0.5 + rad_1 + rad_2 + rad_3 + rad_4 <= x_1
                            and x_2 <= 0.5 + rad_1 + rad_2 + rad_3 + rad_4 + rad_5
                            and 0.5 + rad_1 + rad_2 + rad_3 + rad_4 <= x_2
                        ):
                            type_el[i_el] = 6
                        elif (
                            x_1 <= 0.5 - rad_1 - rad_2 - rad_3 - rad_4
                            and 0.5 - rad_1 - rad_2 - rad_3 - rad_4 - rad_5 <= x_1
                            and x_2 <= 0.5 - rad_1 - rad_2 - rad_3 - rad_4
                            and 0.5 - rad_1 - rad_2 - rad_3 - rad_4 - rad_5 <= x_2
                        ):
                            type_el[i_el] = 6
                        elif (
                            x_1 <= 0.5 + rad_1 + rad_2 + rad_3 + rad_4 + rad_5 + rad_6
                            and 0.5 + rad_1 + rad_2 + rad_3 + rad_4 + rad_5 <= x_1
                            and x_2
                            <= 0.5 + rad_1 + rad_2 + rad_3 + rad_4 + rad_5 + rad_6
                            and 0.5 + rad_1 + rad_2 + rad_3 + rad_4 + rad_5 <= x_2
                            ...
                            x_1 <= 0.5 - rad_1 - rad_2 - rad_3 - rad_4 - rad_5
                            and 0.5 - rad_1 - rad_2 - rad_3 - rad_4 - rad_5 - rad_6
                            <= x_1
                            and x_2 <= 0.5 - rad_1 - rad_2 - rad_3 - rad_4 - rad_5
                            and 0.5 - rad_1 - rad_2 - rad_3 - rad_4 - rad_5 - rad_6
                            <= x_2
...
class Light(object):
    ...
    def __init__(
        self, wl_nm, max_order_PWs=2, k_parallel=None, theta=None, phi=None, n_inc=1.0
    ):
        if np.imag(wl_nm) != 0:
            self.wl_nm = complex(wl_nm)
            print(
                "Warning: using a complex wavelength. EMUstack can only handle these for uniform films using 0 pw_orders."
            )
        else:
        ...
        if None == theta and None == k_parallel:
            raise ValueError(
                "Specify incident angle either by k_parallel OR by theta, phi and n_inc."
            )
        ...
        if None == theta:
            ...
            if np.abs(self.k_pll[0]) == 0 or np.abs(self.k_pll[1]) == 0:
                print(
                    "Warning: a component of k_parallel is exactly zero, this can lead to degeneracies and errors."
                )
        else:
